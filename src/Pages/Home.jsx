...
const Home = () => {
  return (
    <>
      <SEO
        title="KomikHub - Baca Komik Gratis Bahasa Indonesia Terbaru"
        description="Baca komik online gratis di KomikHub. Koleksi lengkap komik terbaru, trending, dan populer dalam bahasa Indonesia. Update setiap hari!"
        keywords="komik indonesia, baca komik gratis, komik online, manga indonesia, manhwa indonesia"
        url="https://komikhub.web.id/"
      />
            ...
            <div className="border-t border-gray-300 dark:border-gray-700 pt-8">
              <div className="text-center">
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  KomikHub - Platform baca komik online terbaik
                </p>
                <p className="text-gray-500 dark:text-gray-500 text-xs mt-2">
                  &copy; 2025 JulianDev. All rights reserved.
                </p>
              </div>
            </div>
          </div>
