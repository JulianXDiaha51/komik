...
const TerbaruPage = () => {
    return (
        <>
            <SEO
                title="Komik Terbaru"
                description="Daftar komik terbaru yang baru saja update. Baca komik online gratis dengan update terbaru setiap hari di KomikHub."
                keywords="komik terbaru, komik baru, update komik, komik hari ini"
                url="https://komikhub.web.id/terbaru"
            />
